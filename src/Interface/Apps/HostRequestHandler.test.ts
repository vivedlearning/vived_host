...
import { HostRequestHandler, HostRequestHandlerFunctions } from "./HostRequestHandler";

function makeTestRig() {
  const handlerFunctions: HostRequestHandlerFunctions = {
    getAppAssetsURL: jest.fn(),
    onStateChange: jest.fn(),
    onStateComplete: jest.fn(),
    submitResults: jest.fn()
  }
  const hostRequestHandler = new HostRequestHandler(handlerFunctions);
  return { handler: hostRequestHandler.handler, handlerFunctions };
}
