...
describe('Observable appObject Repo', () => {
  ...
  it('Get all App Objects with component type', () => {
    ...
    expect(repo.getAllAppObjectsWithComponent(MockComponent.type)).toEqual([appObj2, appObj3]);
  });
  ...
  it('Get all Components', () => {
    ...
    expect(repo.getAllComponents<MockComponent>(MockComponent.type)).toEqual([comp1, comp2]);
  });
