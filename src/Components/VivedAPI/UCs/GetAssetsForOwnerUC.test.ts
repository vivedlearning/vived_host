...
import {
  makeGetAssetsForOwnerUC,
  GetAssetsForOwnerUC
} from "./GetAssetsForOwnerUC";
...
function makeTestRig() {
  ...
  const uc = makeGetAssetsForOwnerUC(appObjects.getOrCreate("ao"));
...
describe("Get Assets for Owner UC", () => {
  ...
  it("Gets the singleton", () => {
    ...
    expect(GetAssetsForOwnerUC.get(appObjects)).toEqual(uc);
  });
