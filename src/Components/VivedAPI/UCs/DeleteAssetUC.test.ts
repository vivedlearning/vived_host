...
import { makeDeleteAssetUC, DeleteAssetUC } from "./DeleteAssetUC";
...
function makeTestRig() {
  ...
  const uc = makeDeleteAssetUC(appObjects.getOrCreate("ao"));
...
describe("Patch Asset Is Archived UC", () => {
  ...
  it("Gets the singleton", () => {
    ...
    expect(DeleteAssetUC.get(appObjects)).toEqual(uc);
  });
